...
<body>
  ...
  <!-- play movie container -->
    <div class="play-container container">
        <!-- Play Image -->
        <video class="vid" loop="" autoplay="" controls="" width="800px" height="600px"  poster="https://cinedope.com/wp-content/uploads/2021/02/Untitled-design-5.jpg">
		<source src="assets/loki/l3.mp4" type="video/mp4">
	</video>
    </div>
