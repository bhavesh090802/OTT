...
<body>
  ...
  <!-- play movie container -->
    <div class="play-container container">
        <!-- Play Image -->
        <video class="vid" loop="" autoplay="" controls="" width="800px" height="600px"  poster="https://www.filmibeat.com/img/2022/05/x1-1651664905.jpg.pagespeed.ic.lxFtPfa9zj.jpg">
		<source src="assets/beast.mp4" type="video/mp4">
	</video>
    </div>
