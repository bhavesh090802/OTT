...
<head>
  <title>The Legend of Hanuman S-2</title>
...
<body>
  ...
  <!-- play movie container -->
    <div class="play-container container">
        <!-- Play Image -->
        <video class="vid" loop="" autoplay="" controls="" width="800px" height="600px"  poster="https://m.media-amazon.com/images/M/MV5BYzE1NWViOTYtZTE0My00ZmM5LTgzYzEtNmUxODQ2MDZlN2VkXkEyXkFqcGdeQXVyNzkyNTg2NzI@._V1_.jpg">
		<source src="assets/hanuman/h2.mp4" type="video/mp4">
	</video>
    </div>
