...
<body>
  ...
  <!-- play movie container -->
    <div class="play-container container">
        <!-- Play Image -->
        <video class="vid" loop="" autoplay="" controls="" width="800px" height="600px"  poster="https://shubhanchal.com/wp-content/uploads/2020/10/Mirzapur-Season-01-1024x576.png">
		<source src="assets/mirzapur/mr1.mp4" type="video/mp4">
	</video>
    </div>
