...
<body>
  ...
  <!-- play movie container -->
    <div class="play-container container">
        <!-- Play Image -->
        <video class="vid" loop="" autoplay="" controls="" width="800px" height="600px"  poster="https://bsmedia.business-standard.com/_media/bs/img/article/2018-09/21/full/1537508419-7958.png">
		<source src="assets/sgames/s2.mp4" type="video/mp4">
	</video>
    </div>
