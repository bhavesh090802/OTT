...
<body>
  ...
  <!-- play movie container -->
    <div class="play-container container">
        <!-- Play Image -->
        <video class="vid" loop="" autoplay="" controls="" width="800px" height="600px"  poster="https://images.indianexpress.com/2022/05/don-siva.jpg">
		<source src="assets/don.mp4" type="video/mp4">
	</video>
    </div>
