...
<body>
  ...
  <!-- play movie container -->
    <div class="play-container container">
        <!-- Play Image -->
        <video class="vid" loop="" autoplay="" controls="" width="800px" height="600px"  poster="https://www.pinkvilla.com/imageresize/ante_sundaraniki_release_date_poster.jpg?width=752&format=webp&t=pvorg">
		<source src="assets/sundar.mp4" type="video/mp4">
	</video>
    </div>
