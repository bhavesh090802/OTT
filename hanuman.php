  ...
  <section class="home swiper" id="home">
    <div class="swiper-wrapper">
      ...
      <div class="swiper-slide container">
        <img src="https://m.media-amazon.com/images/M/MV5BNjk2NjFkNjgtNjM3Ny00Y2MwLWFkNDktNDdkNTQ3OGUxMWZlXkEyXkFqcGdeQXVyMjI5NDMxNjg@._V1_.jpg">
        <div class="home-text">
            <h1>The Legend of Hanuman</h1>
            <span>Season 1</span>
          <a href="h1.php" class="play">
      ...
      <!-- Box-2 -->
      <div class="swiper-slide container">
        <img src="https://assets.gadgets360cdn.com/pricee/assets/product/202112/The-Legend-of-Hanuman2-1200_1639662449.jpg?downsize=680:*">
        <div class="home-text">
            <h1>The Legend of Hanuman</h1>
            <span>Season 2</span>
          <a href="h2.php" class="play">
            <i class='bx bx-play'></i>
          </a>
        </div>
      </div>
