  ...
  <section class="home swiper" id="home">
    <div class="swiper-wrapper">
      ...
      <div class="swiper-slide container">
        <img src="https://i2.cinestaan.com/image-bank/1500-1500/126001-127000/126547.jpg">
        <div class="home-text">
            <h1>Sacred Games</h1>
            <span>Season 1</span>
          <a href="s1.php" class="play">
      ...
      <!-- Box-2 -->
      <div class="swiper-slide container">
        <img src="https://indianspectator.com/wp-content/uploads/2018/09/733-1024x576.jpg">
        <div class="home-text">
            <h1>Sacred Games</h1>
            <span>Season 2</span>
          <a href="s2.php" class="play">
            <i class='bx bx-play'></i>
          </a>
        </div>
      </div>
