...
<head>
  <title>Doctor Strange in the Multiverse of Madness (ENGLISH)</title>
...
<body>
  ...
  <!-- play movie container -->
    <div class="play-container container">
        <!-- Play Image -->
        <video class="vid" loop="" autoplay="" controls="" width="800px" height="600px"  poster="https://s2.dmcdn.net/v/TV6MV1Xn1O4GBjOpW/x1080">
		<source src="assets/mom.mp4" type="video/mp4">
	</video>
    </div>
