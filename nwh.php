...
<head>
  <title>SPIDER-MAN: NO WAY HOME (ENGLISH)</title>
...
<body>
  ...
  <!-- play movie container -->
    <div class="play-container container">
        <!-- Play Image -->
        <video class="vid" loop="" autoplay="" controls="" width="800px" height="600px"  poster="https://cdn.hobbyconsolas.com/sites/navi.axelspringer.es/public/styles/hc_940x529/public/media/image/2021/11/spider-man-no-way-home-2543495.jpg?itok=d4hyKAvQ">
		<source src="assets/nwh.mp4" type="video/mp4">
	</video>
    </div>
